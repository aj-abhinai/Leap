---
title: Introduction
description: Welcome to Leap - A self-hosted pipeline CRM for internal teams
---
...
Leap is a self-hosted pipeline CRM for internal teams. It tracks contacts and leads, and it records every change in an audit log. The whole system runs as a single binary, with no separate asset directories.
...
<CardGrid>
  <Card title="Quickstart" icon="rocket">
    Install and run Leap in minutes. [Get started →](/getting-started/quickstart/)
  </Card>
